...
export default async function patchESLint(eslintDirURL, ESLint)
{
    ...
    async function runWorkers(filePaths, cliOptions, createVerifyTextModuleURL, abortController)
    {
    ...
    async function lintParallel(patterns)
    {
        ...
        (
            [
                runWorkers
                (filePaths, cliOptions, this[createVerifyTextModuleURLKey], abortController),
    ...
    ESLint.fromCLIOptions = fromCLIOptions;
    {
        ...
        prototype[createVerifyTextModuleURLKey] = createVerifyTextModuleURL;
    }
}

const createVerifyTextModuleURL =
String(new URL('../grab/create-verify-text.js', import.meta.url));
