...
export default async function patchESLint(ESLint, eslintDirURL)
{
    ...
    async function createLintSingleFile()
    {
        ...
        function lintSingleFile(filePath)
        {
    ...
    async function runWorkers(filePaths, cliOptions, patchESLintModuleURL)
    {
    ...
    async function lintParallel(patterns)
    {
        ...
        const results = await runWorkers(filePaths, cliOptions, this.patchESLintModuleURL);
