        ...
        (
            ...
            () =>
            {
                ...
                (
                    ...
                    {
                        const code =
                        '--plugin \'hello-cjs, hello-esm\' --rule \'hello-cjs/hello: warn, ' +
                ...
                (
                    ...
                    {
                        const code =
                        '--plugin \'eslint-plugin-schema-array, @scope/eslint-plugin-example\' ' +
                        '--rule \'schema-array/rule1: warn, @scope/example/test: warn\' ' +
                        '../passing.js';
                        const exitCode = await execute(code);
                ...
                (
                    ...
                    async () =>
                    {
                        ...
                        await assert.rejects
                        (execute(code), { message: 'error thrown while loading this module' });
                    },
                );
                ...
                (
                    ...
                    async () =>
                    {
                        ...
                        (
                            ...
                            {
                                message:
                                '"eslint-plugin-no-default-export" cannot be used with the ' +
                                '`--plugin` option because its default module does not provide a ' +
                                '`default` export',
                            },
                        );
                    },
